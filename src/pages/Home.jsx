...
const Home = () => {
    ...
    return (
        <div className="min-h-screen  bg-gray-50 text-gray-800">
            ...
            {/* main sect */}
            <main className="px-6 lg:px-12 py-12 mb-4">
                {/*rounded-2xl shadow-lg shadow-blue-200*/}
                <div className="grid lg:grid-cols-2 gap-12 items-center ">
                    ...
                    <div className="relative">
                        <div
                            ...
                            <p className="leading-relaxed text-gray-800 font-light">
            ...
            {/* features*/}
            <section id="features"
                     className="py-16 px-6 lg:px-12 bg-gray-100  ">
            ...
            {/* analysis */}
            <section id="analysis"
                     className="py-16 px-6 lg:px-12 rounded-2xl  bg-gray-50">
